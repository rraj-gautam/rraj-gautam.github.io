         ...
         <div class="source_option">
          ...
          <div class="row">
            <div class="form-group form-group-sm">
              ...
              <div class="col-sm-6 col-lg-4">
                <input class="form-control" type="text" id="fname" name="fname" placeholder="">
              </div>

              <label class="col-sm-4 col-lg-2 control-label" for="lname">
                Last Name</label>
              <div class="col-sm-6 col-lg-4">
                <input class="form-control" type="text" id="lname" name="lname" placeholder="" value="">
              </div>
            ...
            <div class="form-group form-group-sm">
               <label class="col-sm-4 col-lg-2 control-label" for="dob">
                ...
                <div class="col-sm-6 col-lg-4">
                  ...
                  <input class="form-control" id="dob" name="dob" value="<?php echo date('m/d/Y');?>" placeholder="MM/DD/YYYY" type="date"/>
                ...
                <div class="col-sm-6 col-lg-4">
                  ...
                  <input class="form-control" id="join_date" name="join_date" value="<?php echo date('m/d/Y');?>" placeholder="MM/DD/YYYY" type="date"/>
          ...
          <div class="row">
            <div class="form-group form-group-sm">
                ...
                Designation</label>
              <div class="col-sm-8 col-lg-10">
                <input class="form-control" type="text" id="duty" name="duty" placeholder="HR">
              </div>
